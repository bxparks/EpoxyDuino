...
# These are dependency files generated by $(CXX), which list the used headers of the respective c/cpp files
MAKE_DEPS := $(OBJS:%.o=%.d)

# We need to add a rule to treat .ino file as just a  normal .cpp.
$(APP_NAME).o: $(APP_NAME).ino $(DEPS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -x c++ -c $<

# Compile cpp files and generate Make dependencies
%.o: %.cpp
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -MMD -MP -c $< -o $@

# Compile c files and generate Make dependencies
%.o: %.c
...
# Use 'make clean' to remove intermediate '*.o' and '*.d' files, the target '*.out' file,
# and any generated files defined by $(GENERATED).
clean: $(MORE_CLEAN)
	rm -f $(OBJS) $(MAKE_DEPS) $(APP_NAME).out $(GENERATED)

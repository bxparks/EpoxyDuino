...
#	  example, $(ARDUINO)/libraries, $(ARDUINO)/hardware/arduino/avr/libraries,
#	  $(ARDUINO)/portable/packages/arduino/hardware/avr/1.8.2/libraries, where
#	  $(ARDUINO) is the install location of the Arduino IDE.
